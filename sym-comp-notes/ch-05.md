...
* The line that starts `local` tells Maple the variables `list` and `i` are local to the procedure.  That is, don't use the values outside the procedure if they exist.

...
![Plot of $x^2+1$ and its Riemann sum using left endpoints](images/ch08/plot07.png)
...
![Plot of $x^2+1$ and a Riemann Sum](images/ch08/plot08.png)
...
![Plot of $e^{-x^2}$ on the interval $[0,1]$](images/ch08/plot09.png)
...
![Plot of the trapezoid approximation of $\sin x$ on $[0,\pi]$](images/ch08/plot10.png)
...
![Plot of $f(x)$ and the point $x=0,1,2$](images/ch08/plot11.png)
...
![Plot of $f$, $Q$ and the points through which they pass](images/ch08/plot12.png)
...
![Simpson's rule plot of $f(x)=x{\rm e}^{-x}$](images/ch08/plot13.png)

Chapter 17: Data, Data everywhere
=========
...
![Plot of tree girth and height data](images/ch09/plot07.png)

#### The `Plots.jl` advantage

The power of the `Plots.jl` package is that the syntax is made common for every backend, so you just need to learn one syntax and this also has some very nice features.  

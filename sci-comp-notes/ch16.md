...
Download the file [Gaz_ua_national.txt](other/Gaz_ua_national.txt) and save it somewhere that you can access it from Julia. This file has a lot of census data that we will try to find answers.  
